...
<head>
  ...
  <title>Doubles Score Table - SPEEDSTERS Bowling System</title>
          ...
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              ...
              <ul aria-expanded="false" class="collapse first-level">
                ...
                <li class="sidebar-item">
                  <a href="./score-table-doubles.php" class="sidebar-link active">
                    <i class="ti ti-users"></i>
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td>
                                <div class="d-flex align-items-center">
                                  <div class="d-flex me-2">
                                    <img src="assets/images/profile/user-2.jpg" alt="Player 1" class="rounded-circle border border-2 border-white" width="32" style="margin-right: -8px;">
                                    <img src="assets/images/profile/user-1.jpg" alt="Player 2" class="rounded-circle border border-2 border-white" width="32">
                                  </div>
                                  <div>
                                    <h6 class="mb-0">Thunder Strikers</h6>
                                  </div>
                            ...
                            <tr>
                              ...
                              <td>
                                <div class="d-flex align-items-center">
                                  <div class="d-flex me-2">
                                    <img src="assets/images/profile/user-4.jpg" alt="Player 1" class="rounded-circle border border-2 border-white" width="32" style="margin-right: -8px;">
                                    <img src="assets/images/profile/user-7.jpg" alt="Player 2" class="rounded-circle border border-2 border-white" width="32">
                                  </div>
                                  <div>
                                    <h6 class="mb-0">Spare Seekers</h6>
                                  </div>
